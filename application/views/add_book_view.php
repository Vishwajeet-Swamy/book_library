			...
			<div id="page-content-wrapper">
				...
				<!--flex start-->
                    <div class="d-flex align-content-around flex-wrap">
                        <div class="p-2">
                        <div class="card">
							<img class="card-img-top" id="bookCover" src="" alt="Card image cap">
							</div>
                        </div>
                        <div class="p-2">
						<form>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="imageUrl" placeholder="Image input" value="">
							</div>
							<div class="form-group">
								<label for="count">Count</label>
								<input type="text" class="form-control" id="count" placeholder="Count input">
							</div>
							<div class="form-group">
			...
			// process the form
				$('form').submit(function (event) {
					...
					$.ajax({
						...
						url: '<?php echo site_url('dashboard/save_book_details') ?>', // the url where we want to POST
